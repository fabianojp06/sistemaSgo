 ...
 * de forma atômica: cria a identidade no Clerk, abre `prisma.$transaction`, chama
 * Associar Perfis (US-202), Definir Exceções (US-203) e Definir Acesso Inicial (US-204)
 * com o mesmo `tx`, grava o HistoricoOperacao (USUARIO_CRIADO) e comita.
 * Falha no commit ⇒ excluirIdentidade (compensação).
 *
